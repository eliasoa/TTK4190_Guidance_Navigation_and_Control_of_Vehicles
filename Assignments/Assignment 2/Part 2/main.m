...
simdata2 = zeros(Ns+1,4);       % table of simulation data 2
...
for i=1:Ns+1
    ...
    e_psi       = ssa(x(6) - psi_d);            % error heading
    e_r         = x(3) - r_d;                   % error yaw rate
    e_int       = e_int + h * e_psi;            % integral of heading error
